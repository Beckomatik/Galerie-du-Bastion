...
<main class="container" id="homepage">
    ...
    <div id="intro">
        ...
        <p>Je me déplace dans toute la France pour <strong>réaliser des shootings photos</strong> (n'hésitez pas à me <a
                href="index.php?action=contact" title="page de contact" class="wavy" target="_blank">contacter</a> 😉) et j'en profite en général pour rédiger un
            article sur les lieux que je visite. Vous pouvez les lire dans la partie <strong><a
                    href="index.php?action=blog" title="voir le blog" class="wavy" target="_blank">blog</a></strong></p>
    </div>
    <div id="home-news">
